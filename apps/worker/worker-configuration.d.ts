/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 195a8159602c63d08aba954c069645d8)
// Runtime types generated with workerd@1.20260430.1 2026-04-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WhisperAgent" | "GuestAgent";
	}
	interface ProductionEnv {
		DB: D1Database;
		EMAIL: SendEmail;
		FLAGS: Flagship;
		RATE_LIMIT_1_PER_MIN: RateLimit;
		RATE_LIMIT_5_PER_MIN: RateLimit;
		RATE_LIMIT_10_PER_MIN: RateLimit;
		AI: Ai;
		ENVIRONMENT: "production";
		APP_URL: "https://preview.shadow-whisper.com";
		TRUSTED_ORIGINS: "https://preview.shadow-whisper.com,https://shadow-whisper.com,https://www.shadow-whisper.com";
		AUTH_EMAIL_FROM_NAME: "ShadowWhisper";
		AUTH_EMAIL_FROM_ADDRESS: "noreply@shadow-whisper.com";
		AUTH_EMAIL_REPLY_TO: "support@shadow-whisper.com";
		STRIPE_PRO_MONTHLY: "price_1TaD23CoTB7LGmEBWz6tIlyk";
		STRIPE_PRO_ANNUAL: "price_1TaD29CoTB7LGmEBci0kSUUt";
		GOOGLE_CLIENT_ID: "483727848230-795gjgk9rchagg6a7flko5b2f03667nc.apps.googleusercontent.com";
		AI_GATEWAY_ID: "shadow-whisper-ai-gateway";
		CF_ACCOUNT_ID: "cb0ab4966c11b70aac3c7090f36fb938";
		GUEST_COOKIE_DOMAIN: ".shadow-whisper.com";
		EXTENSION_ID: "";
		AUTH_SECRET: string;
		...
		WhisperAgent: DurableObjectNamespace<import("./src/index").WhisperAgent>;
		GUEST_AGENT: DurableObjectNamespace<import("./src/index").GuestAgent>;
		TEACH_ANALYSIS_WORKFLOW: Workflow<Parameters<import("./src/index").TeachAnalysisWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		DB: D1Database;
		EMAIL: SendEmail;
		...
		APP_URL: "https://preview.shadow-whisper.com" | "http://localhost:3001";
		TRUSTED_ORIGINS: "https://preview.shadow-whisper.com,https://shadow-whisper.com,https://www.shadow-whisper.com" | "http://localhost:3001,http://localhost:5173,http://localhost:8787";
		AUTH_EMAIL_FROM_NAME: "ShadowWhisper";
		AUTH_EMAIL_FROM_ADDRESS: "noreply@shadow-whisper.com" | "noreply@shadowwhisper.local";
		AUTH_EMAIL_REPLY_TO: "support@shadow-whisper.com" | "support@shadowwhisper.local";
		STRIPE_PRO_MONTHLY: "price_1TaD23CoTB7LGmEBWz6tIlyk" | "price_1TIt3DCe3UJROfVPq5ds8wrE";
		STRIPE_PRO_ANNUAL: "price_1TaD29CoTB7LGmEBci0kSUUt" | "price_1TIt3DCe3UJROfVP9JLhd2EU";
		GOOGLE_CLIENT_ID: "483727848230-795gjgk9rchagg6a7flko5b2f03667nc.apps.googleusercontent.com" | "302014322561-vo513tesu5thhsvjap5c8kgc6l7iid95.apps.googleusercontent.com";
		AI_GATEWAY_ID: "shadow-whisper-ai-gateway";
		CF_ACCOUNT_ID: "cb0ab4966c11b70aac3c7090f36fb938";
		GUEST_COOKIE_DOMAIN: ".shadow-whisper.com" | "localhost";
		EXTENSION_ID: "";
		AUTH_SECRET: string;
		STRIPE_SECRET_KEY: string;
		STRIPE_WEBHOOK_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_URL" | "TRUSTED_ORIGINS" | "AUTH_EMAIL_FROM_NAME" | "AUTH_EMAIL_FROM_ADDRESS" | "AUTH_EMAIL_REPLY_TO" | "STRIPE_PRO_MONTHLY" | "STRIPE_PRO_ANNUAL" | "GOOGLE_CLIENT_ID" | "AI_GATEWAY_ID" | "CF_ACCOUNT_ID" | "GUEST_COOKIE_DOMAIN" | "EXTENSION_ID" | "AUTH_SECRET" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "GOOGLE_CLIENT_SECRET" | "GUEST_SECRET" | "AI_GATEWAY_TOKEN" | "GROQ_API_KEY" | "POSTHOG_API_KEY">> {}
}
declare module "*.sql" {
	const value: string;
